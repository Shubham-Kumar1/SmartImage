...
export default function Home() {
	...
	return (
		<main>
			...
			<h1 className={"inline-block text-transparent bg-clip-text py-4 text-6xl font-bold bg-gradient-to-r from-[#FF0000] to-[#000000] font-squarePeg"}>SmartImage</h1>
			</div>
				...
				<form className={"mt-4"} onSubmit={handleSubmit}>
					<div className={"grid grid-cols-1 md:grid-cols-2 gap-4"}>
						<div>
							...
							>
								Provide a depiction of the image you desire to generate:
							</label>
							<textarea
							...
							/>
							<span className={"mt-1 text-xs leading-6 text-primary-main"}>You have the flexibility to offer a highly specific prompt.</span>
						</div>
						<div>
				...
				<div className={"mt-4 pt-4 border-t"}>
					{
						loading
							? <div className={"h-100 flex flex-col justify-center items-center"}>
									<p className={"text-md text-primary-main font-bold my-10"}>Please wait while your message is being processed.</p>
